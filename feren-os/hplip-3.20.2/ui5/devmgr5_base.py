...
# Form implementation generated from reading ui file 'ui5/devmgr5_base.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.pushButton.setGeometry(QtCore.QRect(280, 40, 96, 27))
        # self.pushButton.setObjectName("pushButton")
        # self.label = QtWidgets.QLabel(self.tab_3)
        # self.label.setGeometry(QtCore.QRect(30, 45, 251, 17))
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.pushButton.setText(_translate("MainWindow", "Install now"))
        # self.label.setText(_translate("MainWindow", "New version of HPLIP-x.x.x is available"))
        # self.Tabs.setTabText(self.Tabs.indexOf(self.tab_3), _translate("MainWindow", "Page"))
